...
| io_cancel | cancel.c | addr, fd, file, flags, opcode | io_uring_release | io_uring.c | used in body |
...
| io_cancel | cancel.c | addr, fd, file, flags, opcode | if | slist.h | used in body |
...
| io_cancel | cancel.c | addr, fd, file, flags, opcode | io_waitid_remove_all | waitid.c | used in body |
...
| io_epoll_wait | epoll.c | events, file, maxevents | io_epoll_ctl | epoll.c | used in body |
...
| io_link | fs.c | file, flags, new_dfd, newpath, old_dfd, oldpath | io_disarm_linked_timeout | timeout.h | used in body |
...
| io_futex | futex.c | file, uaddr, union, uwaitv | if | rsrc.c | used in body |
...
| io_worker | io-wq.c | acct, all_list, create_state, create_work, cur_work, flags, init_retries, lock, nulls_node, rcu, ref, ref_done, task, union, work, wq | io_queue_worker_create | io-wq.c | used in body |
...
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_cancel_req_match | timeout.c | used in body |
...
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | if | rsrc.c | used in body |
...
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | __io_register_iowq_aff | register.c | used in body |
...
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_rw_should_reissue | rw.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_do_iopoll | io_uring.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_do_iopoll | io_uring.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_do_iopoll | rw.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_do_iopoll | sqpoll.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_add_after | io-wq.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_add_after | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_add_tail | io-wq.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_add_tail | io_uring.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_add_tail | io_uring.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_add_tail | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_add_head | io_uring.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_add_head | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_cut | io-wq.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_cut | rw.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_cut | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | __wq_list_splice | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_splice | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_stack_add_head | io_uring.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_stack_add_head | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_del | io-wq.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_list_del | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_stack_extract | io_uring.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_stack_extract | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_next_work | io-wq.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | wq_next_work | slist.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_sqpoll_wq_cpu_affinity | register.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_sqpoll_wq_cpu_affinity | sqpoll.c | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_sqpoll_wq_cpu_affinity | sqpoll.h | used in body |
| io_wq | io-wq.c | IO_WQ_ACCT_NR, IO_WQ_NR_HASH_BUCKETS, cpu_mask, cpuhp_node, do_work, free_work, hash, state, task, wait, worker_done, worker_refs | io_init_wq_offload | tctx.c | used in body |
...
| io_cb_cancel_data | io-wq.c | cancel_all, data, fn, nr_pending, nr_running | io_acct_cancel_pending_work | io-wq.c | used in body |
| io_cb_cancel_data | io-wq.c | cancel_all, data, fn, nr_pending, nr_running | io_wq_cancel_pending_work | io-wq.c | used in body |
| io_cb_cancel_data | io-wq.c | cancel_all, data, fn, nr_pending, nr_running | io_acct_cancel_running_work | io-wq.c | used in body |
...
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_enqueue | io-wq.c | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_enqueue | io-wq.h | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_enqueue | io_uring.c | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_cancel_cb | cancel.c | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_cancel_cb | io-wq.c | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_cancel_cb | io-wq.h | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_cancel_cb | io_uring.c | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_create | io-wq.c | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_create | io-wq.h | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_create | tctx.c | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_put_hash | io-wq.c | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_put_hash | io-wq.h | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_wq_put_hash | io_uring.c | used in body |
| io_wq_hash | io-wq.h | map, refs, wait | io_prep_async_work | io_uring.c | used in body |
...
| io_wq_data | io-wq.h | do_work, free_work, hash, task | io_init_wq_offload | tctx.c | used in body |
...
| ext_arg | io_uring.c | argsz, iowait, min_time, sig, ts, ts_set | __io_cqring_wait_schedule | io_uring.c | used in body |
| ext_arg | io_uring.c | argsz, iowait, min_time, sig, ts, ts_set | io_cqring_wait_schedule | io_uring.c | used in body |
| ext_arg | io_uring.c | argsz, iowait, min_time, sig, ts, ts_set | io_cqring_wait | io_uring.c | used in body |
| ext_arg | io_uring.c | argsz, iowait, min_time, sig, ts, ts_set | __io_uring_cancel | io_uring.c | used in body |
| ext_arg | io_uring.c | argsz, iowait, min_time, sig, ts, ts_set | io_get_ext_arg_reg | io_uring.c | used in body |
| ext_arg | io_uring.c | argsz, iowait, min_time, sig, ts, ts_set | io_validate_ext_arg | io_uring.c | used in body |
| ext_arg | io_uring.c | argsz, iowait, min_time, sig, ts, ts_set | io_get_ext_arg | io_uring.c | used in body |
...
| io_tctx_exit | io_uring.c | completion, ctx, task_work | io_ring_exit_work | io_uring.c | used in body |
| io_tctx_exit | io_uring.c | completion, ctx, task_work | io_ring_exit_work | sqpoll.c | used in body |
...
| io_wait_queue | io_uring.h | CONFIG_NET_RX_BUSY_POLL, cq_min_tail, cq_tail, ctx, endif, hit_timeout, min_timeout, napi_busy_poll_dt, napi_prefer_busy_poll, nr_timeouts, t, timeout, wq | io_cqring_schedule_timeout | io_uring.c | used in body |
| io_wait_queue | io_uring.h | CONFIG_NET_RX_BUSY_POLL, cq_min_tail, cq_tail, ctx, endif, hit_timeout, min_timeout, napi_busy_poll_dt, napi_prefer_busy_poll, nr_timeouts, t, timeout, wq | __io_cqring_wait_schedule | io_uring.c | used in body |
| io_wait_queue | io_uring.h | CONFIG_NET_RX_BUSY_POLL, cq_min_tail, cq_tail, ctx, endif, hit_timeout, min_timeout, napi_busy_poll_dt, napi_prefer_busy_poll, nr_timeouts, t, timeout, wq | io_cqring_wait | io_uring.c | used in body |
...
| io_provide_buf | kbuf.c | addr, bgid, bid, file, len, nbufs | io_add_buffers | kbuf.c | used in body |
...
| io_provide_buf | kbuf.c | addr, bgid, bid, file, len, nbufs | io_eopnotsupp_prep | opdef.c | used in body |
| io_buffer_list | kbuf.h | buf_list, buf_ring, not, set, union, used | io_kbuf_inc_commit | kbuf.c | used in body |
| io_buffer_list | kbuf.h | buf_list, buf_ring, not, set, union, used | io_kbuf_commit | kbuf.c | used in body |
| io_buffer_list | kbuf.h | buf_list, buf_ring, not, set, union, used | io_kbuf_commit | kbuf.h | used in body |
...
| io_buffer_list | kbuf.h | buf_list, buf_ring, not, set, union, used | io_provided_buffer_select | kbuf.c | used in body |
| io_buffer_list | kbuf.h | buf_list, buf_ring, not, set, union, used | io_provided_buffers_select | kbuf.c | used in body |
...
| io_buffer_list | kbuf.h | buf_list, buf_ring, not, set, union, used | __io_remove_buffers | kbuf.c | used in body |
...
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_kbuf_inc_commit | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_kbuf_commit | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_kbuf_commit | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffer_get_list | kbuf.c | used in body |
...
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_provided_buffers_select | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_ring_buffer_select | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffer_select | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffer_select | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffer_select | net.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffer_select | rw.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | advise.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | alloc_cache.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | alloc_cache.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | cancel.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | cancel.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | epoll.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | eventfd.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | fdinfo.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | filetable.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | fs.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | futex.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | io-wq.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | io-wq.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | io_uring.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | io_uring.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | memmap.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | msg_ring.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | napi.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | napi.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | net.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | nop.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | notif.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | notif.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | opdef.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | openclose.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | poll.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | refs.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | register.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | rsrc.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | rw.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | slist.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | splice.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | sqpoll.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | statx.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | sync.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | tctx.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | tctx.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | timeout.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | timeout.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | truncate.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | uring_cmd.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | waitid.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | xattr.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | if | zcrx.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffers_select | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffers_select | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffers_select | net.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffers_peek | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffers_peek | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffers_peek | net.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | __io_put_kbuf_ring | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | __io_put_kbufs | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | __io_put_kbufs | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | __io_remove_buffers | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_destroy_buffers | io_uring.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_destroy_buffers | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_destroy_buffers | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_remove_buffers | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_remove_buffers | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_provide_buffers_prep | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_provide_buffers_prep | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_add_buffers | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_provide_buffers | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_provide_buffers | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_register_pbuf_ring | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_register_pbuf_ring | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_register_pbuf_ring | register.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_unregister_pbuf_ring | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_unregister_pbuf_ring | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_unregister_pbuf_ring | register.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_register_pbuf_status | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_register_pbuf_status | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_register_pbuf_status | register.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_pbuf_get_region | kbuf.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_pbuf_get_region | kbuf.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_pbuf_get_region | memmap.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_send_select_buffer | net.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_recvmsg | net.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_recvmsg | net.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_recv_buf_select | net.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_account_mem | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_free_imu | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | __io_sqe_buffers_update | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_free_rsrc_node | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_free_rsrc_node | rsrc.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | headpage_already_acct | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_coalesce_buffer | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_sqe_buffer_register | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_sqe_buffers_register | register.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_sqe_buffers_register | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_sqe_buffers_register | rsrc.h | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_buffer_unregister_bvec | rsrc.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | __io_import_rw_buffer | rw.c | used in body |
| io_buffer | kbuf.h | addr, bgid, bid, len, list | io_zcrx_create_area | zcrx.c | used in body |
...
| buf_sel_arg | kbuf.h | iovs, max_len, mode, nr_iovs, out_len | io_buffers_select | kbuf.c | used in body |
| buf_sel_arg | kbuf.h | iovs, max_len, mode, nr_iovs, out_len | io_buffers_select | kbuf.h | used in body |
| buf_sel_arg | kbuf.h | iovs, max_len, mode, nr_iovs, out_len | io_buffers_select | net.c | used in body |
...
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_lock_external_ctx | msg_ring.c | used in body |
...
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_msg_need_remote | msg_ring.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_msg_tw_complete | msg_ring.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_msg_remote_post | msg_ring.c | used in body |
...
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_msg_data_remote | msg_ring.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | __io_msg_ring_data | msg_ring.c | used in body |
...
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | __io_msg_ring_prep | msg_ring.c | used in body |
...
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_netmsg_recycle | net.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_copy_msghdr_from_user | net.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_sendmsg_setup | net.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_sendmsg_prep | net.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_sendmsg_prep | net.h | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_recvmsg_copy_hdr | net.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_recvmsg_prep_setup | net.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_send_zc_prep | net.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_send_zc_prep | net.h | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_connect_prep | net.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_connect_prep | net.h | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_bind_prep | net.c | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_bind_prep | net.h | used in body |
| io_msg | msg_ring.c | cmd, cqe_flags, dst_fd, file, len, src_fd, src_file, tw, union, user_data | io_eopnotsupp_prep | opdef.c | used in body |
...
| io_shutdown | net.c | file, how | io_ring_exit_work | io_uring.c | used in body |
| io_shutdown | net.c | file, how | io_ring_exit_work | sqpoll.c | used in body |
...
| io_shutdown | net.c | file, how | io_zcrx_scrub | zcrx.c | used in body |
| io_shutdown | net.c | file, how | io_unregister_zcrx_ifqs | io_uring.c | used in body |
| io_shutdown | net.c | file, how | io_unregister_zcrx_ifqs | zcrx.c | used in body |
| io_shutdown | net.c | file, how | io_unregister_zcrx_ifqs | zcrx.h | used in body |
| io_accept | net.c | addr, addr_len, file, file_slot, flags, iou_flags, nofile | io_sendrecv_fail | net.c | used in body |
| io_accept | net.c | addr, addr_len, file, file_slot, flags, iou_flags, nofile | io_sendrecv_fail | net.h | used in body |
...
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | advise.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | alloc_cache.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | alloc_cache.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | cancel.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | cancel.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | epoll.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | eventfd.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | fdinfo.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | filetable.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | fs.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | futex.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | io-wq.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | io-wq.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | io_uring.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | io_uring.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | kbuf.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | kbuf.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | memmap.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | msg_ring.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | napi.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | napi.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | net.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | nop.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | notif.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | notif.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | opdef.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | openclose.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | poll.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | refs.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | register.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | rsrc.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | rsrc.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | rw.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | slist.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | splice.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | sqpoll.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | statx.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | sync.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | tctx.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | tctx.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | timeout.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | timeout.h | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | truncate.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | uring_cmd.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | waitid.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | xattr.c | used in body |
| io_socket | net.c | domain, file, file_slot, flags, nofile, protocol, type | if | zcrx.c | used in body |
...
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | advise.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | alloc_cache.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | alloc_cache.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | cancel.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | cancel.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | epoll.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | eventfd.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | fdinfo.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | filetable.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | fs.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | futex.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | io-wq.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | io-wq.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | io_uring.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | io_uring.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | kbuf.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | kbuf.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | memmap.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | msg_ring.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | napi.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | napi.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | net.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | nop.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | notif.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | notif.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | opdef.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | openclose.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | poll.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | refs.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | register.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | rsrc.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | rsrc.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | rw.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | slist.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | splice.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | sqpoll.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | statx.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | sync.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | tctx.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | tctx.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | timeout.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | timeout.h | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | truncate.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | uring_cmd.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | waitid.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | xattr.c | used in body |
| io_connect | net.c | addr, addr_len, file, in_progress, seen_econnaborted | if | zcrx.c | used in body |
...
| io_bind | net.c | addr_len, file | if | advise.c | used in body |
| io_bind | net.c | addr_len, file | if | alloc_cache.c | used in body |
| io_bind | net.c | addr_len, file | if | alloc_cache.h | used in body |
| io_bind | net.c | addr_len, file | if | cancel.c | used in body |
| io_bind | net.c | addr_len, file | if | cancel.h | used in body |
| io_bind | net.c | addr_len, file | if | epoll.c | used in body |
| io_bind | net.c | addr_len, file | if | eventfd.c | used in body |
| io_bind | net.c | addr_len, file | if | fdinfo.c | used in body |
| io_bind | net.c | addr_len, file | if | filetable.c | used in body |
| io_bind | net.c | addr_len, file | if | fs.c | used in body |
| io_bind | net.c | addr_len, file | if | futex.c | used in body |
| io_bind | net.c | addr_len, file | if | io-wq.c | used in body |
| io_bind | net.c | addr_len, file | if | io-wq.h | used in body |
| io_bind | net.c | addr_len, file | if | io_uring.c | used in body |
| io_bind | net.c | addr_len, file | if | io_uring.h | used in body |
| io_bind | net.c | addr_len, file | if | kbuf.c | used in body |
| io_bind | net.c | addr_len, file | if | kbuf.h | used in body |
| io_bind | net.c | addr_len, file | if | memmap.c | used in body |
| io_bind | net.c | addr_len, file | if | msg_ring.c | used in body |
| io_bind | net.c | addr_len, file | if | napi.c | used in body |
| io_bind | net.c | addr_len, file | if | napi.h | used in body |
| io_bind | net.c | addr_len, file | if | net.c | used in body |
| io_bind | net.c | addr_len, file | if | nop.c | used in body |
| io_bind | net.c | addr_len, file | if | notif.c | used in body |
| io_bind | net.c | addr_len, file | if | notif.h | used in body |
| io_bind | net.c | addr_len, file | if | opdef.c | used in body |
| io_bind | net.c | addr_len, file | if | openclose.c | used in body |
| io_bind | net.c | addr_len, file | if | poll.c | used in body |
| io_bind | net.c | addr_len, file | if | refs.h | used in body |
| io_bind | net.c | addr_len, file | if | register.c | used in body |
| io_bind | net.c | addr_len, file | if | rsrc.c | used in body |
| io_bind | net.c | addr_len, file | if | rsrc.h | used in body |
| io_bind | net.c | addr_len, file | if | rw.c | used in body |
| io_bind | net.c | addr_len, file | if | slist.h | used in body |
| io_bind | net.c | addr_len, file | if | splice.c | used in body |
| io_bind | net.c | addr_len, file | if | sqpoll.c | used in body |
| io_bind | net.c | addr_len, file | if | statx.c | used in body |
| io_bind | net.c | addr_len, file | if | sync.c | used in body |
| io_bind | net.c | addr_len, file | if | tctx.c | used in body |
| io_bind | net.c | addr_len, file | if | tctx.h | used in body |
| io_bind | net.c | addr_len, file | if | timeout.c | used in body |
| io_bind | net.c | addr_len, file | if | timeout.h | used in body |
| io_bind | net.c | addr_len, file | if | truncate.c | used in body |
| io_bind | net.c | addr_len, file | if | uring_cmd.c | used in body |
| io_bind | net.c | addr_len, file | if | waitid.c | used in body |
| io_bind | net.c | addr_len, file | if | xattr.c | used in body |
| io_bind | net.c | addr_len, file | if | zcrx.c | used in body |
...
| io_listen | net.c | backlog, file | io_bind | net.c | used in body |
| io_listen | net.c | backlog, file | io_bind | net.h | used in body |
...
| io_sr_msg | net.c | buf, file, umsg, umsg_compat, union | io_recvmsg_prep_multishot | net.c | used in body |
...
| io_recvzc | net.c | file, flags, ifq, len, msg_flags | io_recv | net.c | used in body |
| io_recvzc | net.c | file, flags, ifq, len, msg_flags | io_recv | net.h | used in body |
...
| io_recvmsg_multishot_hdr | net.c | addr, msg | io_recvmsg_multishot | net.c | used in body |
...
| io_async_msghdr | net.h | CONFIG_NET, addr, clear, controllen, else, endif, fast_iov, msg, namelen, payloadlen, uaddr, vec | io_mshot_prep_retry | net.c | used in body |
| io_async_msghdr | net.h | CONFIG_NET, addr, clear, controllen, else, endif, fast_iov, msg, namelen, payloadlen, uaddr, vec | io_net_import_vec | net.c | used in body |
...
| io_async_msghdr | net.h | CONFIG_NET, addr, clear, controllen, else, endif, fast_iov, msg, namelen, payloadlen, uaddr, vec | io_bundle_nbufs | net.c | used in body |
...
| io_async_msghdr | net.h | CONFIG_NET, addr, clear, controllen, else, endif, fast_iov, msg, namelen, payloadlen, uaddr, vec | io_recvmsg_mshot_prep | net.c | used in body |
...
| io_async_msghdr | net.h | CONFIG_NET, addr, clear, controllen, else, endif, fast_iov, msg, namelen, payloadlen, uaddr, vec | io_recv_finish | net.c | used in body |
| io_async_msghdr | net.h | CONFIG_NET, addr, clear, controllen, else, endif, fast_iov, msg, namelen, payloadlen, uaddr, vec | io_recvmsg_prep_multishot | net.c | used in body |
...
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_assign_file | io_uring.c | used in body |
...
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_poll_issue | io_uring.c | used in body |
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_poll_issue | io_uring.h | used in body |
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_poll_issue | poll.c | used in body |
...
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_uring_op_supported | opdef.c | used in body |
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_uring_op_supported | opdef.h | used in body |
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_uring_op_supported | register.c | used in body |
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_uring_optable_init | io_uring.c | used in body |
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_uring_optable_init | opdef.c | used in body |
| io_issue_def | opdef.h | 1, any, assigned, async_size, auditing, file, int, io_kiocb, io_uring_sqe, iopoll, ioprio, know, list, needed, opcode, plug, selection, vectored, wait | io_uring_optable_init | opdef.h | used in body |
...
| io_cold_def | opdef.h | io_kiocb, name | io_uring_get_opcode | fdinfo.c | used in body |
| io_cold_def | opdef.h | io_kiocb, name | io_uring_get_opcode | opdef.c | used in body |
| io_cold_def | opdef.h | io_kiocb, name | io_uring_optable_init | io_uring.c | used in body |
| io_cold_def | opdef.h | io_kiocb, name | io_uring_optable_init | opdef.c | used in body |
| io_cold_def | opdef.h | io_kiocb, name | io_uring_optable_init | opdef.h | used in body |
| io_open | openclose.c | dfd, file, file_slot, filename, how, nofile | io_eopnotsupp_prep | opdef.c | used in body |
| io_open | openclose.c | dfd, file, file_slot, filename, how, nofile | io_openat_force_async | openclose.c | used in body |
...
| io_open | openclose.c | dfd, file, file_slot, filename, how, nofile | io_openat | openclose.c | used in body |
| io_open | openclose.c | dfd, file, file_slot, filename, how, nofile | io_openat | openclose.h | used in body |
...
| io_close | openclose.c | fd, file, file_slot | io_open_cleanup | openclose.c | used in body |
| io_close | openclose.c | fd, file, file_slot | io_open_cleanup | openclose.h | used in body |
| io_close | openclose.c | fd, file, file_slot | __io_close_fixed | openclose.c | used in body |
| io_close | openclose.c | fd, file, file_slot | __io_close_fixed | openclose.h | used in body |
| io_close | openclose.c | fd, file, file_slot | __io_close_fixed | rsrc.c | used in body |
...
| io_close | openclose.c | fd, file, file_slot | io_files_update_with_index_alloc | rsrc.c | used in body |
| io_close | openclose.c | fd, file, file_slot | io_zcrx_drop_netdev | zcrx.c | used in body |
| io_close | openclose.c | fd, file, file_slot | io_zcrx_ifq_free | zcrx.c | used in body |
| io_close | openclose.c | fd, file, file_slot | io_shutdown_zcrx_ifqs | io_uring.c | used in body |
| io_close | openclose.c | fd, file, file_slot | io_shutdown_zcrx_ifqs | zcrx.c | used in body |
| io_close | openclose.c | fd, file, file_slot | io_shutdown_zcrx_ifqs | zcrx.h | used in body |
...
| io_poll_table | poll.c | 0, error, nr_entries, owning, pt, req, result_mask, value | io_arm_poll_handler | io_uring.c | used in body |
| io_poll_table | poll.c | 0, error, nr_entries, owning, pt, req, result_mask, value | io_arm_poll_handler | poll.c | used in body |
| io_poll_table | poll.c | 0, error, nr_entries, owning, pt, req, result_mask, value | io_arm_poll_handler | poll.h | used in body |
| io_poll_table | poll.c | 0, error, nr_entries, owning, pt, req, result_mask, value | io_poll_add | poll.c | used in body |
| io_poll_table | poll.c | 0, error, nr_entries, owning, pt, req, result_mask, value | io_poll_add | poll.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_try_cancel | cancel.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_try_cancel | cancel.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_try_cancel | timeout.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | __io_commit_cqring_flush | io_uring.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | __io_commit_cqring_flush | io_uring.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_handle_tw_list | io_uring.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_handle_tw_list | io_uring.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_handle_tw_list | sqpoll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | __io_run_local_work_loop | io_uring.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_issue_sqe | io_uring.c | used in body |
...
| io_poll | poll.h | events, file, head, retries, wait | io_should_wake | io_uring.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_should_wake | io_uring.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_should_wake | napi.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_commit_cqring | io_uring.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_commit_cqring | io_uring.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_eopnotsupp_prep | opdef.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | wqe_is_double | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_get_ownership_slowpath | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_get_ownership | poll.c | used in body |
...
| io_poll | poll.h | events, file, head, retries, wait | io_init_poll_iocb | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_remove_entry | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_remove_entries | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | __io_poll_execute | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_execute | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_check_events | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_task_func | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_task_func | poll.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | if | advise.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | if | alloc_cache.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | if | alloc_cache.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | if | cancel.c | used in body |
...
| io_poll | poll.h | events, file, head, retries, wait | io_pollfree_wake | poll.c | used in body |
...
| io_poll | poll.h | events, file, head, retries, wait | __io_queue_proc | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_queue_proc | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_can_finish_inline | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_add_hash | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | __io_arm_poll_handler | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_async_queue_proc | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_arm_poll_handler | io_uring.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_arm_poll_handler | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_arm_poll_handler | poll.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_remove_all | io_uring.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_remove_all | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_remove_all | poll.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_find | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_file_find | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_disarm | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | __io_poll_cancel | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_cancel | cancel.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_cancel | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_cancel | poll.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_parse_events | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_remove_prep | poll.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_remove_prep | poll.h | used in body |
...
| io_poll | poll.h | events, file, head, retries, wait | io_poll_multishot_retry | poll.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | io_poll_multishot_retry | rw.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | if | advise.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | if | alloc_cache.c | used in body |
| io_poll | poll.h | events, file, head, retries, wait | if | alloc_cache.h | used in body |
| io_poll | poll.h | events, file, head, retries, wait | if | cancel.c | used in body |
...
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_slot_flags | filetable.h | used in body |
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_slot_flags | io_uring.c | used in body |
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_slot_file | cancel.c | used in body |
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_slot_file | fdinfo.c | used in body |
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_slot_file | filetable.h | used in body |
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_slot_file | io_uring.c | used in body |
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_slot_file | msg_ring.c | used in body |
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_slot_file | rsrc.c | used in body |
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_slot_file | splice.c | used in body |
...
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_req_assign_rsrc_node | io_uring.c | used in body |
| io_rsrc_node | rsrc.h | buf, file_ptr, refs, tag, type, union | io_req_assign_rsrc_node | rsrc.h | used in body |
...
| io_mapped_ubuf | rsrc.h | acct_pages, dir, folio_shift, is_kbuf, len, nr_bvecs, priv, refs, ubuf, void | io_free_imu | rsrc.c | used in body |
...
| io_mapped_ubuf | rsrc.h | acct_pages, dir, folio_shift, is_kbuf, len, nr_bvecs, priv, refs, ubuf, void | validate_fixed_range | rsrc.c | used in body |
...
| io_mapped_ubuf | rsrc.h | acct_pages, dir, folio_shift, is_kbuf, len, nr_bvecs, priv, refs, ubuf, void | io_vec_fill_bvec | rsrc.c | used in body |
| io_mapped_ubuf | rsrc.h | acct_pages, dir, folio_shift, is_kbuf, len, nr_bvecs, priv, refs, ubuf, void | io_estimate_bvec_size | rsrc.c | used in body |
| io_mapped_ubuf | rsrc.h | acct_pages, dir, folio_shift, is_kbuf, len, nr_bvecs, priv, refs, ubuf, void | io_vec_fill_kern_bvec | rsrc.c | used in body |
| io_mapped_ubuf | rsrc.h | acct_pages, dir, folio_shift, is_kbuf, len, nr_bvecs, priv, refs, ubuf, void | iov_kern_bvec_size | rsrc.c | used in body |
...
| io_imu_folio_data | rsrc.h | buf, folio_shift, folios, included, nr_folios, nr_pages_head, nr_pages_mid | io_region_init_ptr | memmap.c | used in body |
...
| io_imu_folio_data | rsrc.h | buf, folio_shift, folios, included, nr_folios, nr_pages_head, nr_pages_mid | io_coalesce_buffer | rsrc.c | used in body |
| io_imu_folio_data | rsrc.h | buf, folio_shift, folios, included, nr_folios, nr_pages_head, nr_pages_mid | io_sqe_buffer_register | rsrc.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_free_alloc_caches | io_uring.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_eopnotsupp_prep | opdef.c | used in body |
...
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_import_rw_buffer | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_req_rw_cleanup | rw.c | used in body |
...
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_prep_rw | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_init_rw_fixed | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_prep_write_fixed | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_prep_write_fixed | rw.h | used in body |
...
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_prep_readv_fixed | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_prep_readv_fixed | rw.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_prep_writev_fixed | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_prep_writev_fixed | rw.h | used in body |
...
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_readv_writev_cleanup | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_readv_writev_cleanup | rw.h | used in body |
...
| io_rw | rw.c | addr, flags, here, kiocb, len, member | __io_complete_rw_common | rw.c | used in body |
...
| io_rw | rw.c | addr, flags, here, kiocb, len, member | need_complete_io | rw.c | used in body |
...
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | advise.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | alloc_cache.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | alloc_cache.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | cancel.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | cancel.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | epoll.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | eventfd.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | fdinfo.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | filetable.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | fs.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | futex.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | io-wq.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | io-wq.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | io_uring.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | io_uring.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | kbuf.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | kbuf.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | memmap.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | msg_ring.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | napi.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | napi.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | net.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | nop.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | notif.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | notif.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | opdef.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | openclose.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | poll.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | refs.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | register.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | rsrc.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | rsrc.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | slist.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | splice.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | sqpoll.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | statx.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | sync.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | tctx.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | tctx.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | timeout.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | timeout.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | truncate.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | uring_cmd.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | waitid.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | xattr.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | if | zcrx.c | used in body |
...
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_write_fixed | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_write_fixed | rw.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_uring_classic_poll | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_do_iopoll | io_uring.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_do_iopoll | io_uring.h | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_do_iopoll | rw.c | used in body |
| io_rw | rw.c | addr, flags, here, kiocb, len, member | io_do_iopoll | sqpoll.c | used in body |
...
| io_async_rw | rw.h | bytes_done, clear, fast_iov, io, iter, iter_state, meta, meta_state, struct, union, vec, with, wpq | io_import_vec | rw.c | used in body |
| io_async_rw | rw.h | bytes_done, clear, fast_iov, io, iter, iter_state, meta, meta_state, struct, union, vec, with, wpq | __io_import_rw_buffer | rw.c | used in body |
...
| io_async_rw | rw.h | bytes_done, clear, fast_iov, io, iter, iter_state, meta, meta_state, struct, union, vec, with, wpq | io_meta_save_state | rw.c | used in body |
...
| io_splice | splice.c | file_out, flags, len, off_in, off_out, rsrc_node, splice_fd_in | io_tee_prep | splice.c | used in body |
| io_splice | splice.c | file_out, flags, len, off_in, off_out, rsrc_node, splice_fd_in | io_tee_prep | splice.h | used in body |
...
| io_sq_data | sqpoll.h | ctx_list, exited, lock, park_pending, refs, sq_cpu, sq_thread_idle, sqd, state, task_pid, task_tgid, thread, wait, work_time | io_sq_thread_stop | sqpoll.c | used in body |
| io_sq_data | sqpoll.h | ctx_list, exited, lock, park_pending, refs, sq_cpu, sq_thread_idle, sqd, state, task_pid, task_tgid, thread, wait, work_time | io_sq_thread_stop | sqpoll.h | used in body |
| io_sq_data | sqpoll.h | ctx_list, exited, lock, park_pending, refs, sq_cpu, sq_thread_idle, sqd, state, task_pid, task_tgid, thread, wait, work_time | io_put_sq_data | register.c | used in body |
| io_sq_data | sqpoll.h | ctx_list, exited, lock, park_pending, refs, sq_cpu, sq_thread_idle, sqd, state, task_pid, task_tgid, thread, wait, work_time | io_put_sq_data | sqpoll.c | used in body |
| io_sq_data | sqpoll.h | ctx_list, exited, lock, park_pending, refs, sq_cpu, sq_thread_idle, sqd, state, task_pid, task_tgid, thread, wait, work_time | io_put_sq_data | sqpoll.h | used in body |
...
| io_sync | sync.c | file, flags, len, mode, off | io_async_cancel | cancel.c | used in body |
| io_sync | sync.c | file, flags, len, mode, off | io_async_cancel | cancel.h | used in body |
| io_sync | sync.c | file, flags, len, mode, off | __io_sync_cancel | cancel.c | used in body |
| io_sync | sync.c | file, flags, len, mode, off | io_eopnotsupp_prep | opdef.c | used in body |
| io_sync | sync.c | file, flags, len, mode, off | io_register_mem_region | register.c | used in body |
...
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_try_cancel | cancel.c | used in body |
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_try_cancel | cancel.h | used in body |
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_try_cancel | timeout.c | used in body |
...
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_timeout_finish | timeout.c | used in body |
...
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_timeout_remove_prep | timeout.c | used in body |
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_timeout_remove_prep | timeout.h | used in body |
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_translate_timeout_mode | timeout.c | used in body |
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_timeout_remove | timeout.c | used in body |
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_timeout_remove | timeout.h | used in body |
...
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_timeout_prep | timeout.c | used in body |
| io_timeout | timeout.c | completions, file, head, link, list, off, only, prev, repeats, target_seq | io_timeout_prep | timeout.h | used in body |
...
| io_timeout_rem | timeout.c | addr, file, flags, ltimeout, ts, update | io_eopnotsupp_prep | opdef.c | used in body |
| io_timeout_rem | timeout.c | addr, file, flags, ltimeout, ts, update | io_timeout_get_clock | timeout.c | used in body |
...
| io_timeout_rem | timeout.c | addr, file, flags, ltimeout, ts, update | io_translate_timeout_mode | timeout.c | used in body |
...
| io_timeout_rem | timeout.c | addr, file, flags, ltimeout, ts, update | io_disarm_linked_timeout | timeout.c | used in body |
| io_timeout_rem | timeout.c | addr, file, flags, ltimeout, ts, update | io_disarm_linked_timeout | timeout.h | used in body |
...
| io_timeout_data | timeout.h | flags, mode, req, timer, ts | io_timeout_get_clock | timeout.c | used in body |
...
| io_ftrunc | truncate.c | file, len | io_eopnotsupp_prep | opdef.c | used in body |
...
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_try_cancel | cancel.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_try_cancel | cancel.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_try_cancel | timeout.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | advise.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | alloc_cache.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | alloc_cache.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | cancel.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | cancel.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | epoll.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | eventfd.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | fdinfo.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | filetable.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | fs.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | futex.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | io-wq.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | io-wq.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | io_uring.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | io_uring.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | kbuf.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | kbuf.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | memmap.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | msg_ring.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | napi.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | napi.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | net.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | nop.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | notif.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | notif.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | opdef.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | openclose.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | poll.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | refs.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | register.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | rsrc.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | rsrc.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | rw.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | slist.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | splice.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | sqpoll.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | statx.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | sync.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | tctx.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | tctx.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | timeout.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | timeout.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | truncate.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | uring_cmd.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | waitid.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | xattr.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | if | zcrx.c | used in body |
...
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_waitid_compat_copy_si | waitid.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_waitid_copy_si | waitid.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_waitid_finish | waitid.c | used in body |
...
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_waitid_cancel | cancel.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_waitid_cancel | waitid.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_waitid_cancel | waitid.h | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_waitid_remove_all | io_uring.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_waitid_remove_all | waitid.c | used in body |
| io_waitid | waitid.c | file, head, info, infop, options, refs, upid, which | io_waitid_remove_all | waitid.h | used in body |
...
| io_xattr | xattr.c | ctx, file, filename | io_eopnotsupp_prep | opdef.c | used in body |
...
| io_xattr | xattr.c | ctx, file, filename | io_xattr_finish | xattr.c | used in body |
...
| io_zcrx_area | zcrx.h | ____cacheline_aligned_in_smp, area_id, free_count, freelist, ifq, is_mapped, nia, pages, user_refs | __io_zcrx_unmap_area | zcrx.c | used in body |
| io_zcrx_area | zcrx.h | ____cacheline_aligned_in_smp, area_id, free_count, freelist, ifq, is_mapped, nia, pages, user_refs | io_zcrx_unmap_area | zcrx.c | used in body |
...
| io_zcrx_area | zcrx.h | ____cacheline_aligned_in_smp, area_id, free_count, freelist, ifq, is_mapped, nia, pages, user_refs | io_zcrx_free_area | zcrx.c | used in body |
| io_zcrx_area | zcrx.h | ____cacheline_aligned_in_smp, area_id, free_count, freelist, ifq, is_mapped, nia, pages, user_refs | io_zcrx_create_area | zcrx.c | used in body |
...
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | __io_zcrx_unmap_area | zcrx.c | used in body |
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_zcrx_unmap_area | zcrx.c | used in body |
...
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_allocate_rbuf_ring | zcrx.c | used in body |
...
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_zcrx_create_area | zcrx.c | used in body |
...
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_zcrx_drop_netdev | zcrx.c | used in body |
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_close_queue | zcrx.c | used in body |
...
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_zcrx_rqring_entries | zcrx.c | used in body |
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_zcrx_get_rqe | zcrx.c | used in body |
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_zcrx_ring_refill | zcrx.c | used in body |
...
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_zcrx_copy_chunk | zcrx.c | used in body |
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_zcrx_copy_frag | zcrx.c | used in body |
...
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_zcrx_tcp_recvmsg | zcrx.c | used in body |
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_shutdown_zcrx_ifqs | io_uring.c | used in body |
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_shutdown_zcrx_ifqs | zcrx.c | used in body |
| io_zcrx_ifq | zcrx.h | area, cached_rq_head, ctx, dev, if_rxq, lock, netdev, netdev_tracker, rq_entries, rq_lock, rq_ring, rqes | io_shutdown_zcrx_ifqs | zcrx.h | used in body |
