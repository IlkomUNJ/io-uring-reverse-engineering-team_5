...
/**
 * Holds state for a poll update operation, including file, user data, events,
 * and update flags.
 */
...
/**
 * Holds state for a poll wait operation, including poll table, request, entry count,
 * error status, ownership, and result mask.
 */
...
/**
 * Called when a poll wait queue is woken up. Handles event delivery and ownership.
 */
static int io_poll_wake(struct wait_queue_entry *wait, unsigned mode, int sync,
			void *key);

/**
 * Convert a wait_queue_entry to its associated io_kiocb request.
 */
...
/**
 * Check if a wait_queue_entry is a double poll entry.
 */
...
/**
 * Try to get poll request ownership in slowpath, set retry flag if needed.
 */
...
/**
 * Mark a poll request as cancelled by setting the cancel flag.
 */
...
/**
 * Get the double poll structure from a request.
 */
...
/**
 * Get the single poll structure from a request.
 */
...
/**
 * Insert a poll request into the cancel hash table.
 */
...
/**
 * Initialize a poll iocb structure with events and waitqueue.
 */
...
/**
 * Remove a poll entry from its waitqueue if present.
 */
...
/**
 * Remove all poll entries (single/double) from their waitqueues for a request.
 */
...
/**
 * Execute poll completion logic, set result and schedule task work.
 */
...
/**
 * Execute poll completion if ownership is acquired.
 */
...
/**
 * Cancel a poll request and trigger completion.
 */
...
/**
 * Handle POLLFREE wakeup for poll waitqueue, cancel and cleanup request.
 */
...
/**
 * Internal helper to queue a poll wait entry, handling double poll if needed.
 */
...
/**
 * Queue a poll wait entry for a poll request.
 */
...
/**
 * Check if poll can finish inline or needs to be scheduled.
 */
...
/**
 * Add a poll request to the cancel hash table with locking.
 */
...
/**
 * Queue a poll wait entry for an async poll request.
 */
...
/**
 * Find a poll request by user data in the cancel hash table.
 */
...
/**
 * Find a poll request by file descriptor in the cancel hash table.
 */
...
/**
 * Disarm a poll request, removing it from its waitqueue and hash table.
 */
...
/**
 * Cancel a poll request with locking.
 */
...
/**
 * Parse poll events from an io_uring submission queue entry.
 */
...
/**
 * Add a poll request to the waitqueue and hash table.
 */
